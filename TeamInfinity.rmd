...
### Create the fact table for counting article numbers for each journal per period
```{sql connection ="dbcon"}
...
### Create the fact table for counting article numbers for each author per period
```{sql connection ="dbcon"}
